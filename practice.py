...
# # special calculator for division #1

# print("나누기 전용 계산기")
# num1 = int(input("첫 번째 숫자 입력해라 : "))
# num2 = int(input("두번째 숫자 입력해라 : "))
# print("{0} / {1} = {2}".format(num1, num2, int(num1 / num2)))


#

# # special calculator for division #2

# try:
#     print("나누기 전용 계산기")
#     num1 = int(input("첫 번째 숫자 입력해라 : "))
#     num2 = int(input("두번째 숫자 입력해라 : "))
#     print("{0} / {1} = {2}".format(num1, num2, int(num1 / num2)))  # 이렇게 했는데

# except ValueError:  # 혹이 안되면, 예외적인 상황이므로 이렇게 반응한다라는 이 이야기임
#     # 여기서 ValueError는 내가 임의로 정한게 아니라, 위의 실행이 안되었을 시,
#     # 터미널에 ValueError: <--이렇게 뜨게 됨. 그 값을 따와서 넣은 거임.
#     print("에러! 잘못된 값 입력했드아, 숫자를 적어라 똥멍충아!")

# # except ZeroDivisionError:  #방법 1
# #     print("0넣지 마라고, 0넣으면 0밖에 더나오니? 똥멍충아!!!🤬🤬🤬 제대로 된 숫자 넣으라고 했지? 한대맞으면 쓰리강냉이 날아간다")


# except ZeroDivisionError as err:  # 방법2
#     print(err)


# # special calculator for division #3

# try:
#     print("나누기 전용 계산기")
#     nums = []
#     nums.append(int(input("첫 번째 숫자 입력해라 : ")))
#     nums.append(int(input("두번째 숫자 입력해라 : ")))
#     # nums.append(int(nums[0] / nums[1]))
#     print(
#         "{0} / {1} = {2}".format(nums[0], nums[1], nums[2])
#     )  # 맨 위의 nums=[] 리스트와 연계가 되어짐
...
# # except IndexError:  #index error 날떄 방법1
# #     print("I have no idea.")


# except:  # 위에 적힌 에러들 제외한 모든 에러들에 해당됨
#     print("I have no idea.")
